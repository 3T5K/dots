# Generated by Powerlevel10k configuration wizard on 2023-06-24 at 15:45 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_STATUS_FOREGROUND=$cred
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=$cgreen
